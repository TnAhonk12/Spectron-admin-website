<form action="{{route('product.store')}}" method="post" enctype="multipart/form-data" class="backdrop-blur" onsubmit="return validateForm()">
    @csrf
  <!-- Main modal -->
                ...
                <div class="p-4 md:p-5 space-y-4">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="flex">
                            ...
                            <input type="number" step="any"  min="0" max="999999" name="weight" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-r-lg focus:ring-blue-500 focus:border-blue-500 block w-32 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"> 
                        </div>
                    </div>
...
<script>
    function validateForm() {
        ...
        if (photoInput.files.length > 0) {
            ...
            if (fileSize > maxSize) {
                alert('Ukuran file foto harus kurang dari 500 KB');
                return false;
            }
        }
        return true;
